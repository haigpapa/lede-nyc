        ...
        >
            ...
            <div className="flex flex-col gap-3 relative z-10">
                ...
                <div className="flex items-center justify-between">
                    <span className={`text-[10px] font-bold tracking-[0.1em] ${theme.text} uppercase`}>
                        {category} {emoji}
                    </span>
                    {trend && trend.length >= 2 && (
                        <div className="flex items-center gap-1.5">
                            <span className="text-[9px] text-zinc-600 uppercase tracking-wide font-mono">12w</span>
                            <Sparkline
                                values={trend}
                                width={64}
                                height={20}
                ...
                {sqlQuery && (
                    <div className="mt-1">
                        <button
                            ...
                            className={`flex items-center gap-1.5 text-[10px] font-mono font-semibold transition-colors ${showSQL ? theme.text : 'text-zinc-600 hover:text-zinc-400'}`}
                            aria-expanded={showSQL}
                        >
                            <span>{showSQL ? '▼' : '▶'}</span>
                            <span>Show source query</span>
                        </button>
                        {showSQL && (
                            <div className="mt-2 p-3 rounded-lg bg-zinc-950 border border-zinc-800 overflow-x-auto">
                                ...
                                <p className={`text-[9px] font-mono mt-2 pt-2 border-t border-zinc-800 ${theme.text}`}>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative group">
                            ...
                            {/* Tooltip visible on hover / focus-within — works on mobile too */}
